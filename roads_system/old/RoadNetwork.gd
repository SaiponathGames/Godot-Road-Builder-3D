...
#		emit_signal("graph_changed")
#
#func split_at_postion(segment: RoadSegmentLinear, _position: RoadIntersection, road_net_info: RoadNetworkInfo):
...
#
#func split_at_position_with_bezier(segment: RoadSegmentBezier, _position: RoadIntersection, road_net_info: RoadNetworkInfo):
#	var t = segment.project_point(_position.position, true)[1]
#	var points = segment.hull(t)
#
...
#
#
#func join_segments(segment_1: RoadSegmentLinear, segment_2: RoadSegmentLinear, network_info: RoadNetworkInfo):
...
#
#func connect_intersections(start_intersection: RoadIntersection, end_intersection: RoadIntersection, road_net_info: RoadNetworkInfo, do_update: bool = true) -> RoadSegmentLinear:
#	if are_intersections_connected(start_intersection, end_intersection):
#		push_error("Intersections already connected, disconnect the intersection and reconnect again.")
#
#	var segment = RoadSegmentLinear.new(start_intersection, end_intersection, road_net_info, null)
...
#		push_error("Intersections already connected, disconnect the intersection and reconnect again.")
#		return
#	var segment = RoadSegmentBezier.new(start_intersection, middle_intersection, end_intersection, road_net_info, null)
#	start_intersection.connections.append(segment)
#	end_intersection.connections.append(segment)
...
#	return snapped
#
#func get_closest_segment(to_position: Vector3, distance: float = 1.5) -> RoadSegmentLinear:
#	var snapped_segment: RoadSegmentLinear
#	var aabb = _get_aabb_for_query(to_position)
...
#
#func get_closest_bezier_segment(to_position: Vector3, distance: float = 1.5) -> RoadSegmentBezier:
#	var snapped_bezier: RoadSegmentBezier
#	var aabb = _get_aabb_for_query(to_position)
...
#
#func get_connection(start_intersection: RoadIntersection, end_intersection: RoadIntersection, bidirection: bool = false) -> RoadSegmentLinear:
#	if bidirection:
#		if are_intersections_connected(start_intersection, end_intersection):
...
#	return null
#
#func _set_connection(start_intersection: RoadIntersection, end_intersection: RoadIntersection, connection: RoadSegmentLinear):
#	network[[start_intersection, end_intersection]] = connection
#
#func get_connection_with_bezier(start_intersection: RoadIntersection, middle_intersection: RoadIntersection, end_intersection: RoadIntersection) -> RoadSegmentBezier:
#	if are_intersections_connected_with_bezier(start_intersection, middle_intersection, end_intersection):
#		return network[[start_intersection, middle_intersection, end_intersection]]
#	return null
#
#func _set_connection_with_bezier(start_intersection: RoadIntersection, middle_intersection: RoadIntersection, end_intersection: RoadIntersection, connection: RoadSegmentBezier):
...
#		emit_signal("graph_changed")
#
#func delete_connection(connection: RoadSegmentLinear, clear_orphans: bool = true, do_update: bool = true):
#	disconnect_intersections(connection.start_position, connection.end_position, false)
#	if clear_orphans:
...
#		emit_signal("graph_changed")
#
#func delete_connection_with_bezier(connection: RoadSegmentBezier, clear_orphans: bool = true, do_update: bool = true):
